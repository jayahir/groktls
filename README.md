...
<pre>
   ...
   Licensed under the <a href="http://www.apache.org/licenses/LICENSE-2.0.html">The Apache License, Version 2.0</a> (the "License");
...
* `FS` - matches cipher suites using key exchange with forward secrecy (e.g. `DHE` or `ECDHE` key exchange).
